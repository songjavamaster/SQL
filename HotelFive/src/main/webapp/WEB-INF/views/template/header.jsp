	...
	<div class="header-wrap">
		<div class="center-tab">
			<a href="hotelInfo">AboutUs</a> <a href="roomListPage">RoomInfo</a> <a
				...
				alt="logo" src="resources/logo/FinalLogo.png" /></a>
			<div class="dropdown">
				<a>Board▼</a>
				...
				<div class="test_2">
					<div id="login" class="login-box">
						<form method="POST">
							...
							<div class="social-login" style="background: white;">
								<!-- <a href="javascript:void(0); onclick="fn_login(this.form)"><img
                           class="profile" src="resources/logo/kakao_cir.PNG"></a>-->
								<a
									href="https://kauth.kakao.com/oauth/authorize?client_id=60b4cbb2b4d98b3706d239765b492e8c&redirect_uri=http://localhost:8080/hotelfive/loginKakao&response_type=code">로그인</a>
								<!-- <a href="https://kauth.kakao.com/oauth/authorize?client_id=60b4cbb2b4d98b3706d239765b492e8c&redirect_uri=http://localhost:8080/hotelfive/loginKakao&response_type=code">로그인</a> -->
							</div>
