...
//request 에서 title 객체를 가져와서  String title에 넣고
if (title == null || title.isEmpty()) {
	//title이 null이거나 title이 비어있다면 기본값에다가
	title = "Welcome to the KoreaHotel";
	//Welcome to the KoreaHotel을 넣어주세요!
}
...
<script type="text/javascript">
   ...
   function cc() {
    ...
    //위에 내용은 동일하고 
      $('#input_key').val('');
      $('#input_key').focus();
    //보안문자 틀렸는데 그 input박스에 값을 초기화하고
    //포커스를 다시 input박스에 다시 포커싱한다.
   }
	...
	<div class="page-wrapper" style="position: relative;">
		...
		<div class="page-wrapper1">
			...
			<div class="post-slider1">
				...
				<a href="http://localhost:8080/hotelfive/ReviewBoardListPage"
