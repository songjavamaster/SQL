...
public interface HotelFiveDAO {
	...
	public int kakaopayinsertReservation1(int gNo, int mNo, int hNo, int rPeople, int rPrice, String rCheckIn,
			String rCheckOut);

	public int kakaopayinsertReservation2(int gNo, int hNo, String nmName, int rPeople, int rPrice, String rCheckIn,
			String rCheckOut);
...
//**********************************************************************************************************************************************************************
	...
	// 사업자 블랙리스트 요청 void=보낼값이 없을때 쓰면됨.
	   ...
	   //xml파일에 맨위 상단에 설정을 해줬기 때문에 hotelfive xml에 갈수있어요
