...
import com.koreait.hotelfive.command.KakaoPayCommand1;
import com.koreait.hotelfive.command.KakaopayCommand2;
...
public class KakaoPayController {
	...
	//회원
	  ...
	  public @ResponseBody String KakaoPay2(HttpServletRequest request,Model model,String gNo,String gName,String rCheckIn,String rCheckOut,String rPeople,String rPrice,String hNo,String nmPhone,String nmName) {
		 ...
		 System.out.println("승현이의 은밀한 폰번호" + nmPhone);
		 System.out.println("승현이의 은밀한 g" + gNo);
		 System.out.println("승현이의 은밀한 h" + hNo);
