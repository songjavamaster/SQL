...
public class QNABoardListCommand implements Command {
	...
	public void execute(SqlSession sqlSession, Model model) {
		...
		int recordPerPage = 5;
		/*
		 * int beginRecord = ( page-1 ) * recordPerPage + 1;//1//6//11
		 */		int beginRecord2 = ( page-1 ) * recordPerPage ;//0//5
		/*
		 * int endRecord = beginRecord + recordPerPage - 1;//5//10//15
		 */		
		Map<String, Integer> map = new HashMap<String, Integer>();
		map.put("beginRecord2", beginRecord2);
		/*
		 * map.put("beginRecord", beginRecord);//1 map.put("endRecord", endRecord);
		 */
