	    			...
	    			buy_tel :mPhone,
	    				...
	    				if(rsp.success){ 
	    					...
	    					console.log(mNo);
	    					 ...
	    					 +selectItem+"&rPrice="+totalPrice+"&hNo="+hNo;
	    					console.log(rCheckIn);
	    					 $.ajax({
	    				          ...
	    				          // 가맹점 서버 결제 API 성공시 로직
	    				        	...
	    				        	window.location = 'http://localhost:8080/hotelfive/MyReservation?mNo='+mNo;
	    				        });
	    				}else{
	    		...
	    		IMP.request_pay({
	    			...
	    			buy_name: nmName,
	    				...
	    				if(rsp.success){ 
	    					...
	    					console.log(nmName);
	    					 $.ajax({
	    						 	url: "http://localhost:8080/hotelfive/kakaopay2", 
	    				            method: "POST",
	    				            data: sendData,
	    				            success :function(rsp){
	    				            	console.log("성공");
	    				          ...
	    				          // 가맹점 서버 결제 API 성공시 로직
	    				        	alert("결제가 완료되었습니다. 예약확인 페이지로 이동합니다.");
	    				        	window.location = 'http://localhost:8080/hotelfive/findReservationNumber'; 
	    				        });
	    				}else{
	    					alert("메시지("+rsp.error_msg+")");
	    				}
