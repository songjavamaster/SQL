                  ...
                  success: function( data ) {
                     if (  data.result == true ) {
                    	  $.ajax({
                              ...
                              type: 'POST',
                              dataType: 'JSON',
                              data: 'sId=' + $('#login_sId').val() + '&sPw=' + $('#login_sPw').val(),
                              success: function( data ) {
                                 if (  data.result != 'YES') {
      ...
      <div class="test_1">
        ...
        <div class="test_2">
         <div id="login" class="login-box">
            <form method="POST">
                     <h1 >LOGIN</h1><br/>
                      <input class="login-text" id="login_sId" type="text" name="login_sId" placeholder="아이디" autofocus /><br/>
                      <input class="login-text" id="login_sPw" type="password" name="login_sPw" placeholder="비밀번호"/><br/>
