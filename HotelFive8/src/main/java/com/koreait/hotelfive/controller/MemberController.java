...
import com.koreait.hotelfive.command.admin.AdminExtentEventListCommand;
import com.koreait.hotelfive.command.admin.AdminEventListCommand;
import com.koreait.hotelfive.command.admin.AdminHotelApprovalCommand;
import com.koreait.hotelfive.command.admin.AdminHotelListCommand;
import com.koreait.hotelfive.command.admin.AdminPostListCommand;
import com.koreait.hotelfive.command.admin.AdminReviewDeleteOKCommand;
import com.koreait.hotelfive.command.admin.AdminReviewListCommand;
import com.koreait.hotelfive.command.admin.AdminblacklistCommand;
import com.koreait.hotelfive.command.admin.BlackagreeCommand;
import com.koreait.hotelfive.command.admin.BlackdisagreeCommand;
import com.koreait.hotelfive.command.admin.EventApprovalOKCommand;
import com.koreait.hotelfive.command.admin.EventCancleOKCommand;
import com.koreait.hotelfive.command.admin.EventExtendOKCommand;
...
import com.koreait.hotelfive.command.member.AdminSellerExtendOKCommand;
import com.koreait.hotelfive.command.member.AdminSellerListCommand;
...
public class MemberController {
   ...
   @RequestMapping(value="phoneCheck",produces="application/json")
      ...
      public String phoneCheck(HttpServletRequest request, Model model) {
         ...
         HotelFiveDAO hDAO = sqlSession.getMapper(HotelFiveDAO.class);
         JSONObject obj = new JSONObject();
         MemberDTO mDTO = hDAO.phoneCheck(mPhone);
