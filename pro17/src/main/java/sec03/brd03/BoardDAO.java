...
public class BoardDAO {
	...
	public List<ArticleVO> selectAllArticles() {
		...
		try {
			...
			String query = "SELECT function_hierarchical4() AS articleNO, parentNO,imageFileName, @level AS level,title,content,id,writeDate FROM (SELECT @start_with:=0,@articleNO:=@start_with, @level:=0) tbl JOIN t_board ";
